...
in
{
  ...
  options.services.athens = {
    ...
    user = mkOption {
      default = "athens";
      description = lib.mdDoc "User account under which athens runs";
      type = types.str;
    };

    group = mkOption {
      default = "athens";
      description = lib.mdDoc "Group under which athens runs";
      type = types.str;
    };

    diskStorageRoot = mkOption {
      type = types.path;
      description = lib.mdDoc ''
        Root directory for disk storage.
        Only used when `storageType` is set to `disk`.
      '';
      default = "";
    };
    ...
    cloudRuntime = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        Available options are: 'GCP' or 'none'.
      '';
      default = "none";
    };
    ...
    storageType = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        Available options are: 'memory', 'disk', 'mongo', 'gcp', 'minio', 's3', 'azureblob', 'external'
      '';
      default = "memory";
    };
    ...
    traceExporter = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        Available options are: 'jaeger', 'datatog' or empty (none).
      '';
      default = "";
    };
    ...
    statsExporter = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        Available options are: 'prometheus' or empty (none).
      '';
      default = "";
    };
    ...
    noSumPatterns = mkOption {
      type = types.listOf types.str;
      description = lib.mdDoc ''
        List of patterns that Athens will return a 403 for.
      '';
      default = [ ];
    };
    ...
    singleFlightType = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        Possible values are "memory", "etcd", "redis", "redis-sentinel", "gcp" or "azureblob"
      '';
      default = "memory";
    };
    ...
    indexType = mkOption {
      ...
      description = lib.mdDoc ''
        ...
        Possible values are "none", "memory", "mysql" or "postgres".
      '';
      default = "none";
    };
