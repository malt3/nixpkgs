...
let
  ...
  extract_source = f: acc: mangledName: value:
    let
      ...
      name = unmangle_name mangledName;
    ...
    if builtins.isAttrs value && value ? attributes
      && value ? ruleClassName
      && (value.ruleClassName == "http_file"
      || value.ruleClassName == "http_archive"
      || value.ruleClassName == "http_jar"
      || value.ruleClassName == "_distdir_tar"
      || value.ruleClassName == "python_repository")
